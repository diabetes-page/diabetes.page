!(function (e, t) {
  ...
  return (function (e) {
      ...
      (e.exports = a),
        (e.exports.once = function (e, t) {
          return new Promise(function (n, r) {
            function i() {
              void 0 !== s && e.removeListener('error', s),
    ...
    function (e, t, n) {
      ...
      const _ = { window: window.opener || window.parent };
      class b {
        constructor({ postisOptions: e } = {}) {
          (this.postis = g()(v(v({}, _), e))),
      ...
      const O = c(window.location).jitsi_meet_external_api_id,
        L = {};
      let j;
      'number' == typeof O && (L.scope = 'jitsi_meet_external_api_' + O),
      ...
      class q extends i.a {
        constructor(e, ...t) {
          ...
          const {
            ...
            v = a.getItem('jitsiLocalStorage');
          (this._parentNode = s),
            (this._url = (function (e, t = {}) {
              return p(
                I(
                  I({}, t),
                  {},
                  {
                    url: `${
                      t.noSSL ? 'http' : 'https'
                    }://${e}/#jitsi_meet_external_api_id=${N}`,
                  },
                ),
              );
            })(e, {
            ...
            (this._transport = new w({
              backend: new b({
                postisOptions: {
                  ...
                  scope: 'jitsi_meet_external_api_' + N,
        ...
        _createIFrame(e, t, n) {
          const r = 'jitsiConferenceFrame' + N;
            ...
            switch (t) {
              case 'video-conference-joined':
                void 0 !== this._tmpE2EEKey &&
                  (this.executeCommand(R.e2eeKey, this._tmpE2EEKey),
              ...
              case 'participant-left':
                M(this, -1), delete this._participants[r];
                break;
        ...
        executeCommand(e, ...t) {
          e in R
            ? this._transport.sendEvent({ data: t, name: R[e] })
