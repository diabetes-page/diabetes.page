...
export const requests = {
  createAppointment: async (): Promise<AxiosResponse<CreateAppointmentResource>> => Post(`/appointments`, await withAuth()),
  ...
  showUser: async (id: number): Promise<AxiosResponse<SensitiveDataUserResource>> => Get(`/users/${id}`, await withAuth())
};