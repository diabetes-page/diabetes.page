...
export class InitialMigration1614103058509 implements MigrationInterface {
    name = 'InitialMigration1614103058509'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "working_group" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_020551e5695b3e13dbad9624308" UNIQUE ("name"), CONSTRAINT "PK_9cbcc6e96966bec27f605e3c9f4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "appointment" ("id" SERIAL NOT NULL, "startsAt" TIMESTAMP NOT NULL, "endsAt" TIMESTAMP NOT NULL, "conferenceRoom" uuid NOT NULL DEFAULT uuid_generate_v4(), "presentationIndex" integer NOT NULL, "conferenceUpdateCounter" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "trainingId" integer, "presenterId" integer NOT NULL, CONSTRAINT "UQ_2424bd2af5b76462d393be12698" UNIQUE ("conferenceRoom"), CONSTRAINT "PK_e8be1a53027415e709ce8a2db74" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "working_group_appointments_appointment" ADD CONSTRAINT "FK_1c26399e156573d2e85b63adcd3" FOREIGN KEY ("workingGroupId") REFERENCES "working_group"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "working_group_appointments_appointment" ADD CONSTRAINT "FK_9cadd423f542c47a000bb326413" FOREIGN KEY ("appointmentId") REFERENCES "appointment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
