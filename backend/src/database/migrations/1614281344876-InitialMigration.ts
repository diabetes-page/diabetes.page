...
export class InitialMigration1614281344876 implements MigrationInterface {
  name = 'InitialMigration1614281344876';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "topic" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "teachingBaseId" integer NOT NULL, CONSTRAINT "UQ_cc743fc794124b3d6e5b65b28ce" UNIQUE ("teachingBaseId", "name"), CONSTRAINT "PK_33aa4ecb4e4f20aa0157ea7ef61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "teaching_base" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_93144e029694c49d2e9b8211d1a" UNIQUE ("name"), CONSTRAINT "PK_93bfc92b40d26b4890fc26efd96" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "teaching_base_document" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "documentPath" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "teachingBaseId" integer NOT NULL, CONSTRAINT "UQ_f9f55ac3b4e7f529f63aa7491be" UNIQUE ("teachingBaseId", "name"), CONSTRAINT "UQ_ddfd2d9367ba230545ae558e3c4" UNIQUE ("teachingBaseId", "documentPath"), CONSTRAINT "PK_42d545c9baae107a0490fd02472" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "training" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "slides" jsonb NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "teachingBaseDocumentId" integer NOT NULL, "topicId" integer NOT NULL, "creatorId" integer NOT NULL, CONSTRAINT "UQ_85d7aa6bf8c4547bbf63add1080" UNIQUE ("name", "creatorId"), CONSTRAINT "PK_c436c96be3adf1aa439ef471427" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "working_group_users_user" ("workingGroupId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_e5775baa3d24d15c23f6a361dfc" PRIMARY KEY ("workingGroupId", "userId"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "working_group_appointments_appointment" ("workingGroupId" integer NOT NULL, "appointmentId" integer NOT NULL, CONSTRAINT "PK_ae30cf21e883e5fda8ce1c6cb81" PRIMARY KEY ("workingGroupId", "appointmentId"))`,
    );
    await queryRunner.query(
