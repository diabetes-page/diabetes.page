...
export class InitialMigration1614517900541 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "working_group_users_user" ("workingGroupId" uuid NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_e5775baa3d24d15c23f6a361dfc" PRIMARY KEY ("workingGroupId", "userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "working_group_appointments_appointment" ("workingGroupId" uuid NOT NULL, "appointmentId" uuid NOT NULL, CONSTRAINT "PK_ae30cf21e883e5fda8ce1c6cb81" PRIMARY KEY ("workingGroupId", "appointmentId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "teaching_base_document" ADD CONSTRAINT "FK_02909b79eadf941755aaa80f3bc" FOREIGN KEY ("teachingBaseId") REFERENCES "teaching_base"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "training" ADD CONSTRAINT "FK_51e1b82f0dcc580f45b21547892" FOREIGN KEY ("teachingBaseDocumentId") REFERENCES "teaching_base_document"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "training" DROP CONSTRAINT "FK_51e1b82f0dcc580f45b21547892"`);
        ...
        await queryRunner.query(`ALTER TABLE "teaching_base_document" DROP CONSTRAINT "FK_02909b79eadf941755aaa80f3bc"`);
