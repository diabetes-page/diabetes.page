...
export class InitialMigration1610988894216 implements MigrationInterface {
    name = 'InitialMigration1610988894216'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customized_training" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "documentPath" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "consultantId" integer NOT NULL, "trainingTemplateId" integer NOT NULL, CONSTRAINT "UQ_905f9781d9d73bfbb8a04bd9dd8" UNIQUE ("name"), CONSTRAINT "UQ_8ffc50c320b73cd44dce67de092" UNIQUE ("documentPath"), CONSTRAINT "PK_6af78ac8fa2d7eff38077e50fcb" PRIMARY KEY ("id"))`);
