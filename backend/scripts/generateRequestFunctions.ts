...
class RequestBuilder {
  private imports =
    ...
    ' */\n' +
    'import { AxiosError as BaseAxiosError, AxiosResponse } from "axios";\n' +
    'import {Get, Post, Put, Patch, Delete, withAuth} from "./axios";\n\n' +
    'export type ErrorResource<T> = Record<keyof T, string[]>;\n' +
    'export type AxiosError<T> = BaseAxiosError<ErrorResource<T>>;';
  private types: string[] = [];
  private requests: string[] = [];

  public run(): RequestBuilder {
